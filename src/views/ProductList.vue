...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row gap-4 mb-8 justify-between items-center">
      ...
      <div class="w-full md:w-auto flex items-center gap-4 justify-between md:justify-end">
        <CategoryFilter
    ...
    <!-- Loading State -->
    <div v-if="loading && products.length === 0" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <ProductSkeleton v-for="n in 8" :key="n" />
    </div>

    <!-- Empty State -->
    <div v-else-if="!loading && products.length === 0" class="text-center py-16 bg-white rounded-xl border border-gray-100 shadow-sm">
    ...
    <div v-else>
      ...
      <!-- Pagination Controls -->
      <div v-if="totalPages > 1" class="mt-12 flex items-center justify-between border-t border-gray-200 pt-6">
        <button
